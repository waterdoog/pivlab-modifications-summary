...
%% Motion-based mask generator panel
parentitem=get(handles.uipanel25_2, 'Position');
item=[0 1.5+margin/2 parentitem(3) 16.5];
handles.uipanel25_11 = uipanel(handles.uipanel25_2, 'Units','characters', 'Position', [item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'title','Motion-based mask generator', 'Tag','uipanel25_11','fontweight','bold','Visible','off');
item=[0 0 0 0];

parentitem=get(handles.uipanel25_11, 'Position');

item=[margin/4 item(2)+item(4)+margin/2 parentitem(3)/2 1];
handles.motion_percentile_text = uicontrol(handles.uipanel25_11,'Style','text', 'String','Percentile threshold:','HorizontalAlignment','left','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_percentile_text');

item=[parentitem(3)/2 item(2) parentitem(3)/4 1];
handles.motion_percentile = uicontrol(handles.uipanel25_11,'Style','edit', 'String','60','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_percentile','TooltipString','Percentile threshold (0-100, higher=stricter)');

item=[margin/4 item(2)+item(4)+margin/2 parentitem(3)/2 1];
handles.motion_frame_interval_text = uicontrol(handles.uipanel25_11,'Style','text', 'String','Frame interval:','HorizontalAlignment','left','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_frame_interval_text');

item=[parentitem(3)/2 item(2) parentitem(3)/4 1];
handles.motion_frame_interval = uicontrol(handles.uipanel25_11,'Style','edit', 'String','1','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_frame_interval','TooltipString','Frame interval for motion detection');

item=[margin/4 item(2)+item(4)+margin/2 parentitem(3)/2 1];
handles.motion_num_pairs_text = uicontrol(handles.uipanel25_11,'Style','text', 'String','Frame pairs to sample:','HorizontalAlignment','left','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_num_pairs_text');

item=[parentitem(3)/2 item(2) parentitem(3)/4 1];
handles.motion_num_pairs = uicontrol(handles.uipanel25_11,'Style','edit', 'String','10','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_num_pairs','TooltipString','Number of frame pairs to sample');

item=[margin/4 item(2)+item(4)+margin/2 parentitem(3)/2 1];
handles.motion_min_size_text = uicontrol(handles.uipanel25_11,'Style','text', 'String','Min region size (px):','HorizontalAlignment','left','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_min_size_text');

item=[parentitem(3)/2 item(2) parentitem(3)/4 1];
handles.motion_min_size = uicontrol(handles.uipanel25_11,'Style','edit', 'String','1000','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_min_size','TooltipString','Minimum region size in pixels');

item=[margin/4 item(2)+item(4)+margin/2 parentitem(3)/2 1];
handles.motion_smooth_size_text = uicontrol(handles.uipanel25_11,'Style','text', 'String','Smoothing size (px):','HorizontalAlignment','left','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_smooth_size_text');

item=[parentitem(3)/2 item(2) parentitem(3)/4 1];
handles.motion_smooth_size = uicontrol(handles.uipanel25_11,'Style','edit', 'String','3','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_smooth_size','TooltipString','Disk radius for morphological closing (smooths mask boundary)');

item=[margin/4 item(2)+item(4)+margin/2 parentitem(3)*0.55 1.5];
handles.motion_bubble_size_chk = uicontrol(handles.uipanel25_11,'Style','checkbox', 'value',0, 'String','Object detection','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_bubble_size_chk','TooltipString','Enable per-frame object detection (e.g. bubbles)');

item=[parentitem(3)*0.55 item(2) parentitem(3)*0.2 1.5];
uicontrol(handles.uipanel25_11,'Style','text', 'String','Size:','HorizontalAlignment','right','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_bubble_size_text');

item=[parentitem(3)*0.75 item(2) parentitem(3)*0.22 1.5];
handles.motion_bubble_size = uicontrol(handles.uipanel25_11,'Style','edit', 'String','800','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_bubble_size','TooltipString','Min object size in pixels. Only regions larger than this are masked.');

item=[margin/4 item(2)+item(4)+margin/2 parentitem(3)*0.55 1.5];
handles.motion_contrast_pct_chk = uicontrol(handles.uipanel25_11,'Style','checkbox', 'value',1, 'String','CLAHE enhance','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_contrast_pct_chk','TooltipString','Apply CLAHE contrast enhancement before detection');

item=[parentitem(3)*0.55 item(2) parentitem(3)*0.2 1.5];
uicontrol(handles.uipanel25_11,'Style','text', 'String','Pctl:','HorizontalAlignment','right','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_contrast_pct_text');

item=[parentitem(3)*0.75 item(2) parentitem(3)*0.22 1.5];
handles.motion_contrast_pct = uicontrol(handles.uipanel25_11,'Style','edit', 'String','20','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_contrast_pct','TooltipString','Smoothness percentile threshold. Regions with local variance below this percentile are detected.');

item=[margin/4 item(2)+item(4)+margin/2 parentitem(3)*0.55 1.5];
handles.motion_max_objects_chk = uicontrol(handles.uipanel25_11,'Style','checkbox', 'value',1, 'String','Limit objects','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_max_objects_chk','TooltipString','Limit the number of detected objects per frame');

item=[parentitem(3)*0.55 item(2) parentitem(3)*0.2 1.5];
uicontrol(handles.uipanel25_11,'Style','text', 'String','N:','HorizontalAlignment','right','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_max_objects_text');

item=[parentitem(3)*0.75 item(2) parentitem(3)*0.22 1.5];
handles.motion_max_objects = uicontrol(handles.uipanel25_11,'Style','edit', 'String','1','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_max_objects','TooltipString','Keep only the N largest objects per frame.');

item=[margin/4 item(2)+item(4)+margin/2 parentitem(3)*0.55 1.5];
handles.motion_bubble_dilate_chk = uicontrol(handles.uipanel25_11,'Style','checkbox', 'value',1, 'String','Dilate mask','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_bubble_dilate_chk','TooltipString','Expand detected object masks by specified pixels');

item=[parentitem(3)*0.55 item(2) parentitem(3)*0.2 1.5];
uicontrol(handles.uipanel25_11,'Style','text', 'String','Size:','HorizontalAlignment','right','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_bubble_dilate_text');

item=[parentitem(3)*0.75 item(2) parentitem(3)*0.22 1.5];
handles.motion_bubble_dilate = uicontrol(handles.uipanel25_11,'Style','edit', 'String','5','Units','characters', 'Fontunits','points','Position',[item(1)+margin/4 parentitem(4)-item(4)-margin-item(2) item(3)-margin*2/4 item(4)],'Tag','motion_bubble_dilate','TooltipString','Dilate detected objects by this many pixels.');
...
handles.frame_skip_text = uicontrol(handles.multip05,'Style','text', 'String','Frame pair skip:','Units','characters', 'Fontunits','points','HorizontalAlignment','left','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Tag','frame_skip_text');

item=[parentitem(3)/2.5 item(2) parentitem(3)/5 1.5];
handles.frame_skip = uicontrol(handles.multip05,'Style','edit', 'String','1','Units','characters', 'Fontunits','points','Position',[item(1)+margin parentitem(4)-item(4)-margin-item(2) item(3)-margin*2 item(4)],'Tag','frame_skip','TooltipString','Skip frame pairs during analysis. 1=process all pairs, 2=every 2nd pair, 3=every 3rd pair, etc.');
